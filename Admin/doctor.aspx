<%@ Page Title="Doctor" Language="C#" MasterPageFile="~/Admin/AdminSite1.Master" AutoEventWireup="true" CodeBehind="doctor.aspx.cs" Inherits="DoctorAppointmentScheduling.Admin.doctor" %>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <%--<asp:CheckBoxList ID="chkAvailableDays1" CssClass="form-control" runat="server" RepeatDirection="Horizontal" CellPadding="3">
