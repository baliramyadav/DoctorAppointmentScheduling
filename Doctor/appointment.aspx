<%@ Page Title="Appointment" Language="C#" MasterPageFile="~/Doctor/DoctorSite1.Master" AutoEventWireup="true" CodeBehind="appointment.aspx.cs" Inherits="DoctorAppointmentScheduling.Doctor.appointment" %>
            ...
            <div class="col-sm-12">
                ...
                <ajaxToolkit:TabContainer ID="TabContainer1" runat="server">
                    <ajaxToolkit:TabPanel ID="TabPanel1" runat="server">
                        ...
                        <ContentTemplate>
                            <h3 class="alert alert-success">Pending Appointment </h3>
                           ...
                           <%-- <div class="container-fluid" runat="server" id="divupdate">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4" runat="server" id="Divappstatus">
                                        <div class="form-group">
                                            <label>Date:</label>
                                            ...
                                            <asp:Button ID="btnAdd" CssClass="btn btn-success" runat="server" Text="Create Appoinment" />
                                        </div>
